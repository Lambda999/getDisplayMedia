...
void CefBrowserHostImpl::RequestMediaAccessPermission(
  ...
  if (request.video_type == blink::mojom::MediaStreamType::DISPLAY_VIDEO_CAPTURE){
...
void CefBrowserHostImpl::ProcessQueuedAccessRequest(
	...
	Cef::DesktopMediaPicker::DoneCallback done_callback =base::BindRepeating(&CefBrowserHostImpl::OnPickerDialogResults,
...
void CefBrowserHostImpl::OnPickerDialogResults(
	...
	if (media_id.is_null()) {
		...
		devices.push_back(blink::MediaStreamDevice(
			blink::mojom::MediaStreamType::DISPLAY_VIDEO_CAPTURE, media_id.ToString(), media_id.ToString()));
	}
